public class PrimitiveType {
 ...
 //       int x = 128;
        ...
        double a = 1.23;
        float b = 9.45f;    // float 타입은 9.45 말고 9.45f로 해야함
...
//        System.out.println(b);
        ...
        // 문자형
        // char(2 bytes)
        char char_1 = 'a';      //큰 따옴표는 안됨. string은 큰따옴표
        char char_2 = 97;       // 작은 따옴표 없이 숫자 쓰면 아스키코드
        char char_3 = 43;
        char char_4 = 0x61;      // 유니코드 (16진수로 표현)
...
//        boolean bool_4 = 1;         // java에서는 0,1로 boolean 판단 못함
